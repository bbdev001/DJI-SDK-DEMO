...
public class GsProtocolHotPointDemoActivity extends Activity implements OnClickListener
{
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId()) {
            ...
            case R.id.CancelHotPoint : {
                DJIDrone.getDjiGroundStation().cancelHotPoint(new DJIGroundStationTakeOffCallBack() {
