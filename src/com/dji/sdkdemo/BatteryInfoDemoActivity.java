...
public class BatteryInfoDemoActivity extends Activity {
    ...
    private double batteryErrorType = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBattryUpdateInfoCallBack = new DJIBatteryUpdateInfoCallBack(){
            ...
            public void onResult(DJIBatteryProperty state) {
                ...
                sb.append("ErrorType=").append(batteryErrorType).append("\n");
                sb.append("SelfDischargeDay").append(batterySelfDischargeDay).append("\n");
    ...
    private void updateSmartBatteryInfo() {
        ...
        DJIDrone.getDjiBattery().getBatteryErrorType(new DJISmartBatteryExecuteResultCallback(){
