    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.AddWaypointButton:
                ...
                //north
                DJIGroundStationWaypoint mWayPoint1 = new DJIGroundStationWaypoint(homeLocationLatitude+0.0000899322, homeLocationLongitude, 3, 1);
                ...
                //east
                DJIGroundStationWaypoint mWayPoint2 = new DJIGroundStationWaypoint(homeLocationLatitude, homeLocationLongitude+0.0000899322, 1, 1);
                ...
                //north
                DJIGroundStationWaypoint mWayPoint3 = new DJIGroundStationWaypoint(homeLocationLatitude-0.0000899322, homeLocationLongitude, 1, 1);
                ...
                mWayPoint3.addAction(GroundStationOnWayPointAction.Way_Point_Action_Gimbal_Pitch, -90);
                
                mTask.addWaypoint(mWayPoint3);
                
                mTask.finishAction = DJIGroundStationFinishAction.Go_Home;
                mTask.movingMode = DJIGroundStationMovingMode.Remote_Control;
...
//                mWayPoint4.heading = 90;
//                mWayPoint4.maxReachTime = 0; 
//                mWayPoint4.stayTime = 3;         
//                mWayPoint4.hasAction = true;
//                action = new DJIGroundStationWayPointAction();
//                action.actionNum = 2;
//                action.actionRepeat = 2;
//                actionList = new ArrayList<GroundStationOnWayPointAction>();
//                actionList.add(GroundStationOnWayPointAction.Way_Point_Action_Video_Start);
//                actionList.add(GroundStationOnWayPointAction.Way_Point_Action_Stay);
//                actionList.add(GroundStationOnWayPointAction.Way_Point_Action_Video_Stop);
//                action.actionList = actionList;
//                paramsList = new ArrayList<Integer>();
//                paramsList.add(1);
//                paramsList.add(5);
//                paramsList.add(1);
//                mWayPoint4.action = action;
//                action.paramList = paramsList;
