    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.SetWorkMode:
                ...
                strlist.add("Transcode");
                strlist.add("Tuning");
                strlist.add("Powersave");
                strlist.add("Download");
                ...
                mPopupNumberPicker = new PopupNumberPicker(m_context,
                        ...
                        new pickerValueChangeListener(){
                            ...
                            public void onValueChange(int pos1, int pos2) {
                                ...
                                if (CameraVisionType.Camera_Type_Inspire == DJIDrone.getDjiCamera().getVisionType()) {
                                    switch (pos1) {
                                        case 0 : {
                                            mFunctionLayout.setVisibility(View.INVISIBLE);
                                            mCameraPlaybackStateScrollView.setVisibility(View.INVISIBLE);
                                        ...
                                        case 4 : {
                                            ...
                                            mCameraPlaybackStateScrollView.setVisibility(View.VISIBLE);
                                            mScrollView.setVisibility(View.VISIBLE);
                                            mode = CameraMode.Camera_Tuning_Mode;
                                            break;
                                        }
                                        ...
                                        case 5 : {
                                            ...
                                            mCameraPlaybackStateScrollView.setVisibility(View.INVISIBLE);
                                            mScrollView.setVisibility(View.VISIBLE);
                                            mode = CameraMode.Camera_SavePower_Mode;
                                            break;
                                        }
                                        ...
                                        case 6 : {
                                            ...
                                            mCameraPlaybackStateScrollView.setVisibility(View.INVISIBLE);
                                            mScrollView.setVisibility(View.VISIBLE);
                                            mode = CameraMode.Camera_Download_Mode;
                                            break;
                                        }
                                    }
                                } else {
...
//                });  
            ...
            case R.id.camera_multi_edit_download_all_select_btn:
                ...
                //"Dji Sdk"
                DJIDrone.getDjiCamera().downloadAllSelectedFiles("Dji Sdk",new DJIFileDownloadCallBack() {
