/**   
 * Description  : TODO
 * @Title       : RemoteControllerDemoActivity.java 
 * @Package     : com.dji.sdkdemo 
 * @author 	    : changjian.xu  
 * @date        : 2015年4月1日 上午9:55:19 
 * @version     : 1.0
 */
...
public class RemoteControlDemoActivity extends Activity implements OnClickListener{
    ...
    private Button mRemoveMasterBtn;
    private Button mRemoveSlaveBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRemoveMasterBtn = (Button) findViewById(R.id.RemoveMasterBtn);
        mRemoveSlaveBtn = (Button) findViewById(R.id.RemoveSlaveBtn);
        ...
        mRemoveMasterBtn.setOnClickListener(this);
        mRemoveSlaveBtn.setOnClickListener(this);
        ...
        mRemoteControllerUpdateAttitudeCallBack = new DJIRemoteControllerUpdateAttitudeCallBack() {
            ...
            @Override
            public void onResutl(DJIRemoteControllerAttitude status) {
                attitude = status;
                ...
                str.append("Fool Stool: ").append(attitude.foolStool).append("\n");
        ...
        switch (v.getId()) {
            ...
            case R.id.SetPasswordBtn : {
                if (mPwdEditText.getText().length() != 0) {
                    DJIDrone.getDjiRemoteController().setRCPassword(Integer.parseInt(mPwdEditText.getText().toString()), new DJIExecuteResultCallback() {
            ...
            case R.id.GetPasswordBtn : {
                DJIDrone.getDjiRemoteController().getRCPassword(new DJIExecuteIntResultCallback() {
            ...
            case R.id.RemoveMasterBtn : {
                if (mIDEditText.getText().length() != 0) {
                    DJIDrone.getDjiRemoteController().removeMaster(Integer.parseInt(mIDEditText.getText().toString()), new DJIExecuteResultCallback() {
            ...
            case R.id.RemoveSlaveBtn : {
                if (mIDEditText.getText().length() != 0) {
                    DJIDrone.getDjiRemoteController().removeSlave(Integer.parseInt(mIDEditText.getText().toString()), new DJIExecuteResultCallback() {
